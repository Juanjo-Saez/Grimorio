...
- **Pattern:** MVC tradicional de Laravel
- **Estructura:** Controllers en `app/Http/Controllers/`, Models en `app/Models/`, Services en `app/Services/`
- **API:** No hay API REST (solo endpoints web Blade)
- **SDD:** Uso de IA para análisis, testing y documentación técnica
...
- **Auth:** Sesiones tradicionales de Laravel (stateful, simple y segura)
...
- Autenticación con soporte para remember me
...
- **Requisito:** Propietario debe estar autenticado. Usuario invitado accede vía token público en URL
- **Validación:** Sesión para propietario. Token URL para acceso compartido
...
### Sessions
- Laravel sesiones con base de datos o archivo
- CSRF protection en todos los formularios
- `remember_token` para "remember me"
- HTTPS en producción

### Shared Links (Fase 3)
- Tokens públicos hexadecimales únicos (no JWT)
- Almacenados en tabla `shared_links`
- Validación: token válido + access_level
